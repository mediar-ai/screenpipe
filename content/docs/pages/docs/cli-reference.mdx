...
## Configuring a Hugging Face Mirror

If you are using the `screenpipe` CLI and need to download models from Hugging Face (which may be blocked in certain regions like China), you can set the `HF_ENDPOINT` environment variable.
