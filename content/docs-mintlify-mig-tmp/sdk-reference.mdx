...
feel free to use our docs as MCP
...
for detailed information about using the operator api for desktop automation, see the dedicated [operator api](/operator-api) page.
