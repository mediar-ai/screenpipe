---
title: 'Desktop Use: SDK Reference (TypeScript)'
---
...
first, ensure the terminator server is running (see [[terminator/getting-started|Getting Started]]). then, install the necessary dependencies if you haven't already:

```bash
bun install # or npm install / yarn install
```

import the client and locator:

```typescript
import { DesktopUseClient, Locator, ApiError } from 'desktop-use'; // Adjust the path as needed
