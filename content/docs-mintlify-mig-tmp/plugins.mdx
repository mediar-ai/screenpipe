...
description: "Build and monetize plugins (pipes) for screenpipe. Use TypeScript and Next.js to create apps that process screen recordings, generate summaries, and integrate with AI."
icon: "puzzle-piece"
---
