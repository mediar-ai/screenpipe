...
description: "Compare screenpipe to Rewind.ai. screenpipe is the open source, self-hosted alternative with no subscription fees. Local-first, cross-platform, and extensible."
icon: "scale-balanced"
---
...
|---------|-----------|-----------|
| **price** | free (open source) | $19/month |
...
screenpipe is MIT licensed. no subscriptions, no vendor lock-in. your data, your control.
