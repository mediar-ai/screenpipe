---
title: "screenpipe operator API - desktop control via accessibility"
sidebarTitle: "operator api"
description: "Use the screenpipe operator API for desktop control using accessibility roles and elements. Click, type, and interact with any application programmatically."
icon: "computer-mouse"
---
