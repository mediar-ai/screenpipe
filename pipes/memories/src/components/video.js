...
exports.VideoComponent = (0, react_1.memo)(function VideoComponent({ filePath, customDescription, className, startTime, endTime, onLoadStart, }) {
    ...
    return (<div className={(0, utils_1.cn)("w-full max-w-2xl text-center", className)}>
      {isAudio ? (<AudioPlayer startTime={startTime} endTime={endTime} mediaSrc={mediaSrc}/>) : (<video controls className="w-full rounded-md">
          ...
          <source src={mediaSrc} type='video/mp4; codecs="hevc"'/>
          <source src={mediaSrc} type='video/mp4; codecs="avc1.42E01E"'/>
