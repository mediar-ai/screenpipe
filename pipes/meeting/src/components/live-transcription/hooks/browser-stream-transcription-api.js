...
exports.useBrowserTranscriptionStream = useBrowserTranscriptionStream;
const react_1 = require("react");
const use_toast_1 = require("@/hooks/use-toast");
function useBrowserTranscriptionStream(setChunks) {
    const streamingRef = (0, react_1.useRef)(false);
    const socketRef = (0, react_1.useRef)(null);
    const audioContextRef = (0, react_1.useRef)(null);
    const { toast } = (0, use_toast_1.useToast)();
    const startTranscriptionBrowser = (0, react_1.useCallback)(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const ws = new WebSocket('wss://api.deepgram.com/v1/listen?' + new URLSearchParams({
                encoding: 'linear16',
                sample_rate: '16000',
                channels: '1',
                model: 'nova-2',
    ...
    const stopTranscriptionBrowser = (0, react_1.useCallback)(() => {
