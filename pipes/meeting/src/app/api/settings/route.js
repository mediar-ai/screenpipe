    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!settingsManager) {
                ...
                return server_1.NextResponse.json((0, browser_1.getDefaultSettings)(), { status: 200 });
            }
            ...
            return server_1.NextResponse.json({ error: "failed to get settings", details: String(error) }, { status: 500 });
        }
    });
}
function PUT(request) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!settingsManager) {
                console.error("[api/settings] settingsManager is undefined");
                return server_1.NextResponse.json({ error: "settingsManager not found" }, { status: 500 });
            }
