...
export function SearchChat() {
  ...
  const { isAvailable, error } = useAiProvider(settings as AppSettings);
  ...
  const MAX_CONTENT_LENGTH = settings?.aiMaxContextChars ?? 51200;
                ...
                <div className="flex items-center gap-1">
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      {(() => {
                        try {
                          return new URL(item.content.browserUrl).hostname;
                        } catch (e) {
                          return item.content.browserUrl;
                        }
                      })()}
                    </Badge>
                    <Button
