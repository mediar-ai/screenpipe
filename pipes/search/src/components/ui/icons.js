...
exports.IconOllama = IconOllama;
exports.IconEdit = IconEdit;
exports.IconNextChat = IconNextChat;
exports.IconOpenAI = IconOpenAI;
exports.IconVercel = IconVercel;
...
exports.IconArrowElbow = IconArrowElbow;
...
exports.IconLlama = IconLlama;
exports.IconCode = IconCode;
exports.IconClaude = IconClaude;
exports.IconGemini = IconGemini;
const React = __importStar(require("react"));
const utils_1 = require("@/lib/utils");
function IconNextChat(_a) {
    var { className, inverted } = _a, props = __rest(_a, ["className", "inverted"]);
    const id = React.useId();
    return (<svg viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={(0, utils_1.cn)("size-4", className)} {...props}>
      <defs>
...
function IconOpenAI(_a) {
    ...
    return (<svg fill="currentColor" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" className={(0, utils_1.cn)("size-4", className)} {...props}>
...
function IconClaude(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg height="1em" style={{ flex: "none", lineHeight: "1" }} viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
      <title>Claude</title>
...
// ... existing code ...
function IconGemini(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    const id = React.useId();
    return (<svg height="1em" style={{ flex: "none", lineHeight: "1" }} viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg" className={(0, utils_1.cn)("size-4", className)} {...props}>
      <title>Gemini</title>
      <defs>
        <linearGradient id={`gemini-gradient-${id}`} x1="0%" x2="68.73%" y1="100%" y2="30.395%">
          <stop offset="0%" stopColor="#1C7DFF"/>
          <stop offset="52.021%" stopColor="#1C69FF"/>
          <stop offset="100%" stopColor="#F0DCD6"/>
        </linearGradient>
      </defs>
      <path d="M12 24A14.304 14.304 0 000 12 14.304 14.304 0 0012 0a14.305 14.305 0 0012 12 14.305 14.305 0 00-12 12" fill={`url(#gemini-gradient-${id})`} fillRule="nonzero"/>
    </svg>);
}
// ... existing code ...
function IconVercel(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg aria-label="Vercel logomark" role="img" viewBox="0 0 74 64" className={(0, utils_1.cn)("size-4", className)} {...props}>
      <path d="M37.5896 0.25L74.5396 64.25H0.639648L37.5896 0.25Z" fill="currentColor"></path>
    </svg>);
}
function IconGitHub(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={(0, utils_1.cn)("size-4", className)} {...props}>
      <title>GitHub</title>
...
function IconSeparator(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg fill="none" shapeRendering="geometricPrecision" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" viewBox="0 0 24 24" aria-hidden="true" className={(0, utils_1.cn)("size-4", className)} {...props}>
      <path d="M16.88 3.549L7.12 20.451"></path>
    </svg>);
}
function IconArrowDown(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" className={(0, utils_1.cn)("size-4", className)} {...props}>
...
function IconSpinner(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" className={(0, utils_1.cn)("size-4 animate-spin", className)} {...props}>
...
function IconEdit(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={(0, utils_1.cn)("size-4", className)} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"/>
    </svg>);
}
function IconShare(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={(0, utils_1.cn)("size-4", className)} viewBox="0 0 256 256" {...props}>
