...
exports.useNotionSettings = useNotionSettings;
...
function useNotionSettings() {
    ...
    const updateSettings = (newSettings) => __awaiter(this, void 0, void 0, function* () {
        try {
            // Split settings
            const { screenpipeAppSettings } = newSettings, notionSettings = __rest(newSettings, ["screenpipeAppSettings"]);
            // Update notion settings in localStorage
            const mergedNotionSettings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), notionSettings);
            // Update screenpipe settings if provided
            if (screenpipeAppSettings) {
                yield (0, get_screenpipe_app_settings_1.updateScreenpipeAppSettings)(Object.assign(Object.assign({}, screenpipeAppSettings), { customSettings: Object.assign(Object.assign({}, screenpipeAppSettings.customSettings), { notion: mergedNotionSettings }) }));
            }
            localStorage.setItem(STORAGE_KEY, JSON.stringify(mergedNotionSettings));
            // Update state with everything
            setSettings(Object.assign(Object.assign({}, mergedNotionSettings), { screenpipeAppSettings: screenpipeAppSettings || (settings === null || settings === void 0 ? void 0 : settings.screenpipeAppSettings) }));
            return true;
        }
        catch (error) {
