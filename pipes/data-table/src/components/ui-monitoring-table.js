...
exports.UiMonitoringTable = UiMonitoringTable;
...
const columns = [
    ...
    },
    {
        ...
        cell: ({ row }) => <badge_1.Badge variant="outline">{row.getValue("app")}</badge_1.Badge>,
    },
    {
        accessorKey: "window",
        header: ({ column }) => {
    ...
    },
    {
        ...
        cell: ({ row }) => {
          ...
          <dropdown_menu_1.DropdownMenuContent align="end">
            ...
            <dropdown_menu_1.DropdownMenuItem onClick={() => navigator.clipboard.writeText(uiMonitoring.text_output)}>
              copy text
            </dropdown_menu_1.DropdownMenuItem>
            <dropdown_menu_1.DropdownMenuItem onClick={() => navigator.clipboard.writeText(JSON.stringify(uiMonitoring, null, 2))}>
              copy raw data
            </dropdown_menu_1.DropdownMenuItem>
    ...
    const fetchData = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          `,
            ...
            setError(`failed to load ui monitoring data: ${error instanceof Error ? error.message : "unknown error"}`);
        }
        finally {
            setIsLoading(false);
        }
