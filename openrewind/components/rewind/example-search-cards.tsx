            ...
            <TooltipTrigger asChild>
              <div
                className={`relative group h-[150px] ${
                  isHealthError ? "opacity-50 cursor-not-allowed" : ""
                }`}
              >
                <div className="absolute inset-0 rounded-lg transition-all duration-300 ease-out group-hover:before:opacity-100 group-hover:before:scale-100 before:absolute before:inset-0 before:rounded-lg before:border-2 before:border-foreground before:opacity-0 before:scale-95 group-hover:before:opacity-100 group-hover:before:scale-100 before:transition-all before:duration-300 before:ease-out" />
                <Card
                  className={`cursor-pointer relative bg-card border border-border z-10 h-full transition-transform duration-300 ease-out ${
