...
impl UiEvent {
    ...
    pub fn to_db_insert(&self, session_id: Option<String>) -> screenpipe_db::InsertUiEvent {
        ...
        let (event_type, x, y, delta_x, delta_y, button, click_count, key_code, modifiers, text_content, app_pid) =
            match &self.data {
                EventData::Click {
                    x,
                    y,
                ...
                EventData::Key { key_code, modifiers } => (
                    UiEventType::Key,
                    None,
                    None,
                    None,
        ...
        let (element_role, element_name, element_value, element_description, element_automation_id, element_bounds) =
