class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.1.87/screenpipe-0.1.87-aarch64-apple-darwin.tar.gz"
  version "0.1.87"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "3d207c53d960bf4aa0450b053b45d7bb358253f069d19a0aeef5884341625f9c" # arm64
    else
