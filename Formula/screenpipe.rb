class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.1.93/screenpipe-0.1.93-aarch64-apple-darwin.tar.gz"
  version "0.1.93"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "9b5f2af13e6b061211219eb5d66759e3a3763049be5092d110ad69649d7ac9cf" # arm64
    else
