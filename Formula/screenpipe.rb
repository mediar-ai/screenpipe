class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.1.91/screenpipe-0.1.91-aarch64-apple-darwin.tar.gz"
  version "0.1.91"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "605383a8c94bb99287f012db783d00bf4e1186522008e5f309b72d593fbef01a" # arm64
    else
