...
[pipes](/pipes) are scheduled AI agents (`.md` files) that run on your screen data. an AI agent (like [pi](https://github.com/mariozechner/pi-coding-agent)) reads the prompt, queries the screenpipe API, and takes action.
